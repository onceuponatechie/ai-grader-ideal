...
This repo contains the first two connected screens.

## The two screens

**1 · Start** — One decision to begin. Name the assessment and press **Start**.
...
The product is a single React component (`src/App.jsx`), styled with Tailwind.
